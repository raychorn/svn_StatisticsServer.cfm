...
<cfoutput>
	...
	<head>
		...
		<script language="JavaScript1.2" type="text/javascript">
			...
			function changeServerStatus(sObj, serverNum) {
				...
				//	alert('sObj = [' + sObj + ']' + ', sObj.options[' + sObj.selectedIndex + '].value = [' + sObj.options[sObj.selectedIndex].value + ']' + ', sObj.options[' + sObj.selectedIndex + '].text = [' + sObj.options[sObj.selectedIndex].text + ']' + ', serverNum = [' + serverNum + ']');
				}
			}
		</script>
	</head>
	...
	<cfif (NOT Request.clusterDBError)>
		...
		<table width="100%" cellpadding="-1" cellspacing="-1" style="margin-bottom: 10px">
			...
			<tr>
				<td align="center">
					<iframe id="iframe_server1" src="clusterStatusInterface.cfm?debugMode=0&serverNum=1" width="100%" height="100" frameborder="0" scrolling="Auto"></iframe>
				</td>
				<td align="center">
					<iframe id="iframe_server2" src="clusterStatusInterface.cfm?debugMode=0&serverNum=2" width="100%" height="100" frameborder="0" scrolling="Auto"></iframe>
				</td>
			</tr>
		</table>
	<cfelse>
