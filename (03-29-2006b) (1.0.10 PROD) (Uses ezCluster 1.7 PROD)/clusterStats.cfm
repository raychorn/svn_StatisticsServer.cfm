			...
			<tr>
				<td align="left" valign="top">
					...
					<cfscript>
						...
						safely_execSQL('qGetHistory', DSN, "SELECT serverNum, elapsedMs FROM ClusterStats WHERE (jobStep = 'T') AND (beginDt >= CAST('00:00:00.0 #FORM.BEGINDT#' as datetime)) AND (beginDt <= CAST('23:59:59.9 #FORM.ENDDT#' as datetime))#_orderByClause#");
					</cfscript>
